...
export const mockCourses: CourseDto[] = [
  {
    ...
    techniques: "Bassteg, basic turns, side basic, enkla partnerbyten och trygg social frame.",
  ...
  },
  {
    ...
    techniques: "Inside turn, outside turn, hand changes, enkla sensual transitions och tydligare viktöverföring.",
  ...
  },
  {
    ...
    techniques: "Body waves, isolations, cambre-förberedelse, musicality breaks och transitions mellan close/open position.",
